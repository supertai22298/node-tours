...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic3VwZXJ0YWkyMjI5OCIsImEiOiJja2tuY25yM3czMWJiMm9xdWw5N3RyM3g3In0.otu_9JvHEbxSSY7unpjnZg';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/supertai22298/ckkndfe755m0t17qt7cgbatej',
    scrollZoom: false // center: [108.173206, 16.048718],
    // zoom: 8,
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            if (res.status === 200) {
              (0, _alert.showAlert)('success', res.data.status);
              location.reload();
            }
...
},{"./alert":"alert.js"}],"booking.js":[function(require,module,exports) {
"use strict";
...
/* eslint-disable no-undef */
var bookingTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51H6nh5FLvYAKFg2hViObnph7EfcmdW8pDZ9nxiqnBaPROmURSjBQKb806bCC5wDvNO5NVNwlZDIIk25lkoAFrjaH00ZUKAErVg');
            _context.prev = 1;
            _context.next = 4;
            return axios({
              method: 'GET',
...
exports.bookingTour = bookingTour;
...
if (locations) (0, _mapbox.displayMap)(JSON.parse(locations.dataset.locations));
var logoutBtn = document.getElementById('logoutBtn');
if (logoutBtn) logoutBtn.addEventListener('click', _login.logout);
var updateMeForm = document.getElementById('updateMeForm');
if (updateMeForm) updateMeForm.addEventListener('submit', function (event) {
  event.preventDefault();
  var email = document.getElementById('email').value;
...
var bookingBtn = document.getElementById('bookTourBtn');
if (bookingBtn) bookingBtn.addEventListener('click', /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return (0, _booking.bookingTour)(tourId);
